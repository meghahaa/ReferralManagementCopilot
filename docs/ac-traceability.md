...
| **AC-02** | Supervisor Orchestrator Worker Routing | `src/referral_copilot/graph/supervisor.py` | `tests/test_ac_02_supervisor_routing.py` | `scripts/generate_evidence.py` | ✓ PASSED |
| **AC-03** | Conditional Edges Route on State | `src/referral_copilot/graph/router.py` | `tests/test_ac_03_conditional_edges.py` | `scripts/generate_evidence.py` | ✓ PASSED |
| **AC-04** | Validated Pydantic Structured Output | `src/referral_copilot/models/schemas.py` | `tests/test_ac_04_structured_output.py` | `scripts/generate_evidence.py` | ✓ PASSED |
...
| **AC-06** | Tiered Memory System | `src/referral_copilot/memory/tiered.py` | `tests/test_ac_06_tiered_memory.py` | `scripts/generate_evidence.py` | ✓ PASSED |
...
| **AC-08** | Memory Eviction / Importance Policy | `src/referral_copilot/memory/eviction.py` | `tests/test_ac_08_eviction_policy.py` | `scripts/generate_evidence.py` | ✓ PASSED |
| **AC-09** | Custom MCP Server (2 Tools, 1 Resource) | `src/referral_copilot/mcp/server.py` | `tests/test_ac_09_mcp_server.py` | `scripts/generate_evidence.py` | ✓ PASSED |
...
| **NFR-03**| Untrusted Note Context Quarantine | `src/referral_copilot/context/quarantine.py`| `tests/test_nfr_03_quarantine.py` | Quarantined log outputs | ✓ PASSED |
...
| **NFR-08**| Context Summarization Middleware | `src/referral_copilot/context/summarizer.py` | `tests/test_nfr_08_summarization.py` | `scripts/generate_evidence.py` | ✓ PASSED |
