...
- **Storage Engine**: SQLite database located at [data/memory.db](file:///home/megha/Documents/Virtusa/Capstone2/ReferralManagementCopilot/src/referral_copilot/memory/tiered.py).
- **Verification Test**: Implemented in [test_ac_07_cross_session_memory.py](file:///home/megha/Documents/Virtusa/Capstone2/ReferralManagementCopilot/tests/test_ac_07_cross_session_memory.py).
...
The eviction engine in [eviction.py](file:///home/megha/Documents/Virtusa/Capstone2/ReferralManagementCopilot/src/referral_copilot/memory/eviction.py) enforces two eviction passes:
