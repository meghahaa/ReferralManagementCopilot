...
| **LLM08: Vector and Embedding Weaknesses** | Low-relevance or manipulative RAG retrieval. | FAISS cosine retrieval with configurable `RAG_RELEVANCE_THRESHOLD` (default `0.35`). | [tool.py](file:///home/megha/Documents/Virtusa/Capstone2/ReferralManagementCopilot/src/referral_copilot/rag/tool.py) |
